(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/forms'), require('amexio-ng-extensions'), require('@angular/router'), require('@angular/common/http'), require('platform-commons')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/forms', 'amexio-ng-extensions', '@angular/router', '@angular/common/http', 'platform-commons'], factory) :
	(factory((global['codepipeline-ms-ui'] = {}),global.core,global.common,global.forms,global.amexioNgExtensions,global.router,global.http,global.platformCommons));
}(this, (function (exports,core,common,forms,amexioNgExtensions,router,http,platformCommons) { 'use strict';
...
exports.CodePipelineNotificationComponent = CodePipelineNotificationComponent;
